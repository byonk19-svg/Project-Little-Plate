# Personal Recipe Planning Implementation Plan (completed locally)
...
> **Completion note:** All steps below were completed on the local feature
> branch. Hosted promotion remains intentionally out of scope.
...
- [x] **Step 1: Write the domain tests first**
...
- [x] **Step 3: Implement the pure domain normalization**
...
- [x] **Step 6: Add integration tests against real Supabase**
...
- [x] **Step 3: Implement pure HTML extraction**
...
- [x] **Step 5: Implement safe public fetch action**
...
- [x] **Step 3: Implement the routes and forms**
...
- [x] **Step 1: Add transport tests first**
...
- [x] **Step 2: Inspect safety-sensitive call paths**
